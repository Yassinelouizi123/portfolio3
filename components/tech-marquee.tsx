...
export function TechMarquee() {
  ...
  return (
    <section id="skills" className="relative py-24 overflow-hidden md:py-32">
      ...
      >
        <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">{t.tech.sectionLabel}</p>
      </motion.div>

      <div className="space-y-4">
        <MarqueeRow items={t.tech.techItems} direction="left" />
        <MarqueeRow items={t.tech.concepts} direction="right" />
      </div>
    </section>
  )
}
