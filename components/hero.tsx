  ...
  return (
    <section id="hero" ref={containerRef} className="relative h-screen w-full overflow-hidden bg-[#050505]">
      ...
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 md:px-12 md:py-20">
        ...
        >
          <h2 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
            {t.hero.topLine}
            <br />
            <span className="italic">{t.hero.topLineItalic}</span>
          </h2>
        </motion.div>
        ...
        >
          <h2 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
            {t.hero.bottomLine}
            <br />
            <span className="italic">{t.hero.bottomLineItalic}</span>
          </h2>
        </motion.div>
      </motion.div>
      ...
      >
        ...
        >
          <span className="font-mono text-[10px] tracking-widest text-muted-foreground uppercase">{t.hero.scroll}</span>
