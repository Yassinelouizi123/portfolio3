...
export function About() {
  ...
  return (
    <section id="philosophy" ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      {/* Section Header */}
      <motion.div
      ...
      >
        <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-4">{t.about.sectionLabel}</p>
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">{t.about.title}</h2>
      </motion.div>

      {/* Horizontal Scroll Container */}
      <div className="relative flex items-center overflow-hidden py-0 gap-0 h-24 md:h-32 lg:h-40">
